...
import com.jd.alpha.skill.client.entity.response.directive.jd.ShoppingDirective;
...
public class ResponseTest {
    ...
    public void testUUID() {
        ...
        skuList.add(1000L);
        List<Directive> directiveList = new ArrayList<>();
        directiveList.add(ShoppingDirective.builder()
                .payload(ShoppingDirective.Payload.builder()
                        .keyword("矿泉水")
                        .skuList(skuList)
                        .build())
                .build());
